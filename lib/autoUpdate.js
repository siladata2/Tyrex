/*****************************************************************************
 *  AUTO-UPDATE SYSTEM — REDXBOT302 (INTERNAL — DO NOT EXPOSE)              *
...
const UPDATE_REPO_OWNER = 'AbdulRehman19721986';
const UPDATE_REPO_NAME  = 'redxminibot_beckend';
...
function httpsGet(url) {
  return new Promise((resolve, reject) => {
    https.get(url, { headers: { 'User-Agent': 'redxbot302-autoupdate/1.0' } }, res => {
