...
async function handleMessages(sock, messageUpdate) {
  try {
    ...
    if (message.message?.buttonsResponseMessage) {
      ...
      if (buttonId === 'channel') {
        await sock.sendMessage(chatId, { text: '*Join our Channel:*\n[https://whatsapp.com/channel/0029VbDAQiXHbFV0iSwCtz2o](https://whatsapp.com/channel/0029VbDAQiXHbFV0iSwCtz2o)' }, { quoted: message });
        return;
      }
      if (buttonId === 'owner') {
      ...
      if (buttonId === 'support') {
        await sock.sendMessage(chatId, { text: '*Support*\n\nhttps://whatsapp.com/channel/0029VbDAQiXHbFV0iSwCtz2o' }, { quoted: message });
        return;
      }
    }
