...
function nlCtx(botName,nlJid,botImg,repo){return{forwardingScore:999,isForwarded:true,forwardedNewsletterMessageInfo:{newsletterJid:nlJid||'120363402325089913@newsletter',newsletterName:botName||'SILA X MINI',serverMessageId:-1},externalAdReply:{title:botName||'SILA X MINI',body:'Owner: Richard Besisila',thumbnailUrl:botImg||'https://i.ibb.co/Gf4fr5BS/silaxmini.jpg',sourceUrl:repo||'https://github.com/Sila-Md',mediaType:1,renderLargerThumbnail:false}};}
