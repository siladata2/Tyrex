...
function nlCtx(botName,nlJid,botImg,repo){return{forwardingScore:999,isForwarded:true,forwardedNewsletterMessageInfo:{newsletterJid:nlJid||'120363429539292697@newsletter',newsletterName:botName||'TYREX_KSH MD',serverMessageId:-1},externalAdReply:{title:botName||'TYREX_KSH MD',body:'Owner: TYREX_KSH TECH',thumbnailUrl:botImg||'https://files.catbox.moe/p8xi4o.jpeg',sourceUrl:repo||'https://github.com/Sila-Md',mediaType:1,renderLargerThumbnail:false}};}
