 ...
 * @returns {Promise<Buffer>}
 */
async function addExif(webpBuffer, packname = 'SILA X MINI Stickers', author = 'Richard Besisila', categories = ['🤖']) {
 ...
 * @returns {Promise<Buffer>}
 */
async function createSticker(buffer, packname = 'SILA X MINI Stickers', author = 'Richard Besisila', categories = ['🤖']) {
    const type = await fileTypeFromBuffer(buffer);
