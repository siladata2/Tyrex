 ...
 * @returns {Promise<Buffer>}
 */
async function addExif(webpBuffer, packname = 'TYREX_KSH MD Stickers', author = 'TYREX_KSH TECH', categories = ['🤖']) {
 ...
 * @returns {Promise<Buffer>}
 */
async function createSticker(buffer, packname = 'TYREX_KSH MD Stickers', author = 'TYREX_KSH TECH', categories = ['🤖']) {
    const type = await fileTypeFromBuffer(buffer);
