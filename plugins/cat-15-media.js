...
try {
  const _m = (function() {
    ...
    'use strict';
/*****************************************************************************
 *  .topdf — Convert quoted image/text/document to PDF (TYREX_KSH MD)
 *****************************************************************************/
...
try {
  const _m = (function() {
    ...
    'use strict';
/*****************************************************************************
 *  .todocument — Convert quoted image/text to Word DOCX (TYREX_KSH MD)
 *****************************************************************************/
        ...
        sections: [{
            ...
            children: [
                ...
                new Paragraph({
                    children: [
                        new TextRun({
                            text  : `Generated by TYREX_KSH MD`,
                            color : '888888',
                            size  : 18,
                            italics: true,
                        }),
